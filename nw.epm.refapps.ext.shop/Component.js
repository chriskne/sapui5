...
jQuery.sap.require("nw.epm.refapps.ext.shop.shopRouter");
...
sap.ui.core.UIComponent.extend("nw.epm.refapps.ext.shop.Component", {
    metadata : {
        ...
        routing : {
            ...
            "config" : {
                "routerClass" : nw.epm.refapps.ext.shop.shopRouter,
                "viewType" : "XML",
    ...
    init : function() {
        ...
        // The service URL for the oData model depends on the environment that the app is running in
        var sServiceUrl = (typeof window.useODataPrefix !== "undefined" ? sRootPath : "") +
